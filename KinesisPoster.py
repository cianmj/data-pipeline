...
class KinesisPoster(threading.Thread):
    ...
    def __init__(self, stream_name, partition_key, poster_time=30, quiet=False,
                 name=None, group=None, default_records=None, filename=None, 
                 args=(), kwargs={}):
        ...
        if self.default_records is None:
            self.default_records = ['asdf','jkl;']
    ...
    def add_records(self, records):
        ...
        if len(records) is 1:
            self._pending_records.append(records)
        else:
            self._pending_records.append(records)
        ...
        if args.describe_only is True:
            ...
            for pid in xrange(args.poster_count):
                ...
                poster = KinesisPoster(
                    ...
                    default_records=[make_string(10),make_string(20)],
